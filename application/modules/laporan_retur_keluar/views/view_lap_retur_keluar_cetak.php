<html><head>
  ...
  <!-- Main content -->
  <div class="container">     
      <h2 style="text-align: center;"><strong>Laporan Pengeluaran Retur Barang - PT. SPB</strong></h2>
      <h4 style="text-align: center;"><strong>Periode Tanggal : <?php echo $tanggal ?></strong></h4>
    <table id="tabelLaporanKeluar" class="table table-bordered table-hover" cellspacing="0" width="100%" border="2">
      <thead>
        <tr>
          <th style="width: 10px; text-align: left;">No</th>
          <th style="width: 50px; text-align: center;">Tanggal</th>
          <th style="width: 40px; text-align: center;">ID</th>
          <th style="width: 120px; text-align: left;">Penerima Retur</th>
          <th style="width: 150px; text-align: left;">Nama Barang</th>
          <th style="width: 20px; text-align: left;">Satuan</th>
          <th style="width: 20px; text-align: left;">Qty</th>
