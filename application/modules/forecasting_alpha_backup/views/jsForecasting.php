        ...
        $.ajax({
            ...
            success : function(data) {
                ...
                $('#tbl_peramalan').append('<tr class="tbl_s2t_row" id="row_peramalan">'
                                        +'<th>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">s2t</span></a>'
                                        +'</th></tr>');
                $('#tbl_peramalan').append('<tr class="tbl_at_row" id="row_peramalan">'
                                        +'<th>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">at</span></a>'
                                        +'</th></tr>');
                $('#tbl_peramalan').append('<tr class="tbl_bt_row" id="row_peramalan">'
                                        +'<th>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">bt</span></a>'
                                        +'</th></tr>');
                $('#tbl_peramalan').append('<tr class="tbl_ft_row" id="row_peramalan">'
                                        +'<th>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">ft</span></a>'
                                        +'</th></tr>');
                $('#tbl_peramalan').append('<tr class="tbl_ae_row" id="row_peramalan">'
                                        +'<th>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">ae</span></a>'
                                        +'</th></tr>');
                $('#tbl_peramalan').append('<tr class="tbl_sqe_row" id="row_peramalan">'
                                        +'<th>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">sqe</span></a>'
                                        +'</th></tr>');
                $('#tbl_peramalan').append('<tr class="tbl_ape_row" id="row_peramalan">'
                                        +'<th>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">ape</span></a>'
                                        +'</th></tr>');
                //append hasil
                $('#tbl_peramalan').append('<tr class="tbl_ftp1p_row" id="row_peramalan">'
                                        +'<td colspan="'+totalColSpan+'"><strong>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">Hasil Peramalan Barang (Ft+1p)</span></a>'
                                                +' = <span class="hasil_peramalan">'+data.peramalan+'</span>'
                                            +'</strong></td>');
                $('#tbl_peramalan').append('<tr class="tbl_mad_row" id="row_peramalan">'
                                        +'<td colspan="'+totalColSpan+'"><strong>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">Mean Absolute Deviation (MAD)</span></a>'
                                                +' = <span class="hasil_mad">'+data.mad+'</span>'
                                            +'</strong></td>');
                $('#tbl_peramalan').append('<tr class="tbl_mad_row" id="row_peramalan">'
                                        +'<td colspan="'+totalColSpan+'"><strong>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">Mean Square Error (MSE)</span></a>'
                                                +' = <span class="hasil_mse">'+data.mse+'</span>'
                                            +'</strong></td>');
                $('#tbl_peramalan').append('<tr class="tbl_mad_row" id="row_peramalan">'
                                        +'<td colspan="'+totalColSpan+'"><strong>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_des"><span style="font-size: 14px">Mean Absolute Percentage Error (MAPE)</span></a>'
                                                +' = <span class="hasil_mape">'+data.mape+' %</span>'
                                            +'</strong></td>');
                $('#tbl_peramalan').append('<tr class="tbl_note_row" id="row_peramalan">'
                                        +'<td colspan="'+totalColSpan+'"><strong>Catatan :</strong> Peramalan yang baik merupakan permalan dengan nilai presentase MAPE terkecil </td></tr>');
                //chart.js
    ...
    if(confirm('Apakah anda yakin Menyimpan Data Peramalan ?')) {
      ...
      /*  alert(alpha);
        ...
        $.ajax({
            url : url,
            type: "POST",
            data: { alpha : alpha, idBarang : idBarang, tglRamal : tglRamal, hasilRamal : hasilRamal, hasilMad : hasilMad, hasilMse : hasilMse, hasilMape : hasilMape},
            dataType: "JSON",
            success: function(data)
            {
