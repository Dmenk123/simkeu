<html><head>
  ...
  <div class="container">
    <?php foreach ($hasil_header as $val ) : ?>
      ...
      <h2 style="text-align: center;"><strong>Form Purchase Order</strong></h2>
      <table class="tbl-header">
        <tr>
          <td align="left" class="head-left">
            <p style="text-align: left; font-size: 14px" class="head-left"><strong>Surabaya, <?php echo $val->tgl_trans_beli; ?></strong></p>
          </td>
          <td align="right" class="head-right">
            <p style="text-align: right; font-size: 14px" class="head-right">ID PO : <strong><?php echo $val->id_trans_beli; ?></strong></p>
          </td>
        </tr> 
        <tr> 
          <td align="left" class="head-left" colspan="2">
            <p style="text-align: left; font-size: 12px" class="head-left">Kepada Yth : <strong><?php echo $val->nama_supplier; ?></strong></p>
          </td>
        </tr>
        <tr class="head-left"> 
          <td align="left" class="head-left" colspan="2">
       ...
       <tr class="inner-head-left"> 
          <td align="left" class="inner-head-left" colspan="2">
            <p style="text-align: left; font-size: 12px" class="inner-head-left">Dengan hormat, kami dari <strong>PT SPB</strong> bermaksud melakukan pembelian barang kepada PT/Toko/Sdr : <strong><?php echo $val->nama_supplier; ?></strong> sebagaimana yang telah disetujui sesuai dengan harga yang ditawarkan sebelumnya, Berikut barang-barang yang akan kami pesan :</p>
          </td>
        </tr>    
      </table>
    <?php endforeach ?>
      ...
      <table class="tbl-content-footer">
        <tr class="content-footer-left"> 
          <td align="left" class="content-footer-left" colspan="5">
            <p style="text-align: left; font-size: 12px" class="content-footer-left">Dimohon agar dapat memberi belasan tentang ketersediaan barang/perubahan harga/perubahan spesifikasi, dengan membalas melalui <strong>telp/fax : 031-7663771</strong> atau <strong>email : suryopj@yahoo.com</strong>, serta saat pengiriman agar disertai dengan copy/scan PO dari kami, Terima kasih.</p>
          </td>
        </tr>  
      </table>
    <table class="tbl-footer">
        <tr>
          ...
          <td align="center">
            <p style="text-align: center;" class="foot-right"><strong>Disetujui Oleh</strong> </p>
          </td>
          <td align="right">
            <p style="text-align: right;" class="foot-right"><strong>Kepada Yth</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
          </td>
        </tr>
        <tr>
          <td align="left">
          ...
          <td align="center">
            <p style="text-align: center;" class="foot-right">( Suryo Putro ) </p>
          </td>
          <td align="right">
