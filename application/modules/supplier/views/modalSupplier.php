                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                               <!--  <input name="alamatSupplier" placeholder="Alamat Supplier" class="form-control" type="text"> -->
                                <textarea name="alamatSupplier" placeholder="Alamat Supplier" class="form-control" rows="5"></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="telpSupplier" placeholder="Telp Supplier" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">Status Supplier</label>
                            <div class="col-md-9">
                                <select name="statusSupplier" class="form-control">
