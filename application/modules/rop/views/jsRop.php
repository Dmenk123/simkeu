...
$(document).ready(function() {
   ...
   //select2
    ...
    $( "#field_periode_rop" ).select2({
        placeholder: "Pilih periode ROP",
        allowClear: true
    });

    $( "#lead_time" ).select2({
        placeholder: "Pilih Lead time",
        allowClear: true
    });

    $( "#service_level" ).select2({
        placeholder: "Pilih Service Level",
        allowClear: true
    });

    //reset select2
    $('#btn_reset_rop').click(function(event) {
        $("#field_periode_rop").val('').trigger('change');
        $("#field_barang_rop").val('').trigger('change');
    });

    $('#btn_reset_rop2').click(function(event) {
        $("#lead_time").val('').trigger('change');
        $("#service_level").val('').trigger('change');
    });
