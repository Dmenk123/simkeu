                ...
                $('#tbl_peramalan').append('<tr class="tbl_alpha_row" id="row_peramalan">'
                                        +'<td colspan="'+totalColSpan+'"><strong>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_alpha"><span style="font-size: 14px">Nilai Alpha (α) yang digunakan</span></a>'
                                                +' = <span class="hasil_alpha_min">'+data.alpha+'</span>'
                                            +'</strong></td>');
                $('#tbl_peramalan').append('<tr class="tbl_alpha_min_row" id="row_peramalan">'
                                        +'<td colspan="'+totalColSpan+'"><strong>'
                                            +'<a href="#" data-toggle="modal" data-target="#modal_help_alpha"><span style="font-size: 14px">Nilai Alpha (α) yang disarankan</span></a>'
