                ...
                <div class="form-row">
                  <form id="form_alpha" action="#">
                    <div class="form-group">
                      <label class="control-label" style="text-align: left;">Alpha (α) <a href="#" data-toggle="modal" data-target="#modal_help_alpha"><span style="font-size: 10px; font-style: italic;">Apa itu Alpha ?</span></a></label>
                      <select class="form-control" style="width:100%;" id="field_alpha" name="fieldAlpha" required>
                        <option value="<?php echo $alpha_1; ?>"><?php echo $alpha_1; ?></option>
                        <option value="<?php echo $alpha_2; ?>"><?php echo $alpha_2; ?></option>
                        <option value="<?php echo $alpha_3; ?>"><?php echo $alpha_3; ?></option>
                      </select>
                      <input type="hidden" name="fieldAlpha1" id="field_alpha_1" value="<?php echo $alpha_1; ?>">
