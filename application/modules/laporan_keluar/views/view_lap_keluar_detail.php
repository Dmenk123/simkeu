          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <div class="col-xs-12">
                  <h4 style="text-align: center;"><strong>Laporan Pengeluaran Barang - PT. SPB</strong></h4>
                </div>
                <div class="col-xs-12">
                  <h4 style="text-align: center;">Periode Tanggal : <?php echo $tanggal ?></h4>
                </div>
                  <table id="tabelLaporanKeluarDetail" class="table table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th style="width: 180px; text-align: center;">pengambil</th>
                    ...
                    <?php $no = 1; ?>
                        <?php foreach ($hasil_data as $val ) : ?>
                          <tr>
                        <td><?php echo $no++; ?></td> 
                        <td><?php echo $val->tgl_trans_keluar_detail; ?></td>
                  ...
                  <div style="padding-top: 30px; padding-bottom: 10px;">
                    ...
                    <?php $link_print = site_url("laporan_keluar/cetak_report_pengeluaran/".$tglAwal."/".$tglAkhir.""); ?>
                    <?php echo '<a class="btn btn-sm btn-success" href="'.$link_print.'" target="_blank" title="Print Laporan Pengeluaran" id="btn_print_laporan_masuk"><i class="glyphicon glyphicon-print"></i> Cetak</a>';?>
                  </div>
              </div>  
            </div>
            <!-- /.box-body -->
