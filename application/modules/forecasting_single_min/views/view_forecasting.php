            ...
            <div class="box-body">
              ...
              <div class="form-row">
                ...
                <label class="control-label">Pilih Periode Perhitungan Pemakaian : </label>
                  <select name="periodeForecast" class="form-control col-md-4" required="" id="field_periode_forecast" style="width:100%;">
                    <option value=""></option>
                ...
                <label class="control-label">Pilih Nama Barang : </label>
                  <select name="barangRamal" class="form-control col-md-4" required="" id="field_barang_ramal" style="width:100%;">
                    <option value=""></option>
                  </select>
                </div>
              </div>
            ...
            <div class="box-footer">
               <div class="form-row">
                  <div class="form-group">
                    ...
                    <button type="reset" class="btn btn-default" id="btn_reset_f1">reset</button>
