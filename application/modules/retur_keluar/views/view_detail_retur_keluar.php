          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
                ...
                <div class="col-xs-12">
                  <h2 style="text-align: center;"><strong>Detail Pengeluaran Retur Barang - PT. SPB</strong></h2>
                </div>
                <div class="col-xs-4">
                  <h4 style="text-align: left;">Nama Petugas : <?php echo $val->nama_lengkap_user; ?></h4>
                </div>
                <div class="col-xs-4">
                  <h4 style="text-align: center;">Tanggal Retur: <?php echo $val->tgl_retur_keluar; ?></h4>
                </div>
                <div class="col-xs-4">
                ...
                <?php endforeach ?>
                  <table id="tabelReturKeluarDetail" class="table table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th style="width: 20px; text-align: center;">ID Trans Masuk</th>
                  ...
                  <div style="padding-top: 30px; padding-bottom: 10px;">
                    ...
                    <?php $link_print = site_url('retur_keluar/cetak_surat_jalan_retur/').$id; ?>
                    <?php echo '<a class="btn btn-sm btn-success" href="'.$link_print.'" title="Print Surat Jalan Retur" id="btn_print_beli_detail" target="_blank"><i class="glyphicon glyphicon-print"></i> Cetak</a>';?>
                  </div>
              </div>  
            </div>
            <!-- /.box-body -->
