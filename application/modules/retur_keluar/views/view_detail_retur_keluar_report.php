<html><head>
  ...
  <div class="container">
    <?php foreach ($hasil_header as $val ) : ?>
      ...
      <h2 style="text-align: center;"><strong>Surat Jalan Retur</strong></h2>
      <table class="tbl-header">
        <tr>
          <td align="left" class="head-left">
            <p style="text-align: left; font-size: 14px" class="head-left"><strong>Surabaya, <?php echo $val->tgl_retur_keluar; ?></strong></p>
          </td>
          <td align="right" class="head-right">
            <p style="text-align: right; font-size: 14px" class="head-right">No Retur Keluar : <strong><?php echo $val->id_retur_keluar; ?></strong></p>
          </td>
        </tr> 
        <tr> 
          <td align="left" class="head-left" colspan="2">
            <p style="text-align: left; font-size: 12px" class="head-left">Diretur Kepada : <strong><?php echo $val->nama_supplier; ?></strong></p>
          </td>
        </tr>
        <tr class="head-left"> 
          <td align="left" class="head-left" colspan="2">
    ...
    <table id="tbl_content" class="table table-bordered table-hover" cellspacing="0" width="100%" border="1">
      ...
      <table class="tbl-content-footer">
        <tr class="content-footer-left"> 
          <td align="left" class="content-footer-left" colspan="5">
            <p style="text-align: left; font-size: 12px" class="content-footer-left">Dimohon agar surat jalan ini diperlihatkan kepada petugas <strong>security</strong> pada saat meninggalkan pabrik, Serta mohon <strong>dibawa kembali</strong> surat jalan ini ketika mengembalikan retur dari kami, Terima kasih.</p>
          </td>
        </tr>  
      </table>
      <table class="tbl-footer">
        <tr>
          ...
          <td align="left">
            <p style="text-align: left;" class="foot-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>SPV Gudang</strong></p>
          </td>
          <td align="center">
            <p style="text-align: center;" class="foot-right">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Manager</strong></p>
          </td>
          <td align="right">
            <p style="text-align: right;" class="foot-right"><strong>Penerima Retur</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
          </td>
          <td align="right">
            <p style="text-align: right;" class="foot-right"><strong>Security</strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
          </td>
        </tr>
        <tr>
          <td align="left">
          ...
          <td align="left">
            <p style="text-align: left;" class="foot-left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ( Ony Cahyono ) </p>
          </td>
          <td align="center">
