            ...
            <div class="box-body">
              <form id="form_input">
                <div class="form-group col-md-12">
                  ...
                  <input type="text" class="form-control" id="username" name="username" value="<?php if(isset($hasil_data)){echo $hasil_data->nip;}?>">
                  ...
                  <label>Role / Level User : </label>
                    <select class="form-control" id="role" name="role">
                      <?php foreach ($data_role as $key => $role) {
                        if (isset($hasil_data)) { ?>
                          <option value="<?= $role->id_level_user; ?>" <?php if ($hasil_data->id_role == $role->id_level_user) {echo "selected";}?>><?= $role->nama_level_user; ?></option>
                        <?php }else{ ?>
