<!-- Bootstrap modal -->
<!-- modal_form_beli -->
<div class="modal fade" id="modal_form_retur_masuk" role="dialog">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-inline">
                    <div class="form-group">
                        <label class="lbl-modal">ID Retur IN: </label>
                        <input type="text" class="form-control" id="form_id_retur_masuk" name="fieldIdReturMasuk" readonly="">
                    </div>
                    <div class="form-group">
                        <label class="lbl-modal">Tanggal : </label>
                        <input type="text" class="form-control" id="form_tanggal_retur_masuk" name="fieldTanggalReturMasuk" required>
                        <!-- <span class="help-block"></span> -->
                    </div>
                     <br />
                    <div class="form-group">
                        <label class="lbl-modal">Petugas : </label>
                        <input type="text" class="form-control" id="form_user_retur_masuk" name="fieldUserReturMasuk" value="<?php echo $this->session->userdata('username');?>" readonly>
                        <input type="hidden" class="form-control" id="form_id_user_retur_masuk" name="fieldIdUserReturMasuk" value="<?php echo $this->session->userdata('id_user');?>" readonly>
                    </div>
                    <div class="form-group">
                       <label class="lbl-modal">ID Retur Out : </label>
                        <select class="form-control" style="width:200px;" id="form_id_retur_keluar" name="fieldIdReturKeluar"></select>
                    </div>
                    <div class="form-group">
