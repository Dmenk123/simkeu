...
class Mod_proses_gaji extends CI_Model
{
	...
	var $column_order = array('tbl_jabatan.nama','tbl_set_gaji.gaji_pokok','tbl_set_gaji.gaji_perjam', 'tbl_set_gaji.gaji_tunjangan_jabatan', null); 
	var $column_search = array('tbl_jabatan.nama','tbl_set_gaji.gaji_pokok','tbl_set_gaji.gaji_perjam', 'tbl_set_gaji.gaji_tunjangan_jabatan'); 
