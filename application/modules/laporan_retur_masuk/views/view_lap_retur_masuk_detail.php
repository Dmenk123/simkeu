    ...
    <section class="content-header">
      <h1>
        Laporan Penerimaan Retur Barang
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i>Laporan</a></li>
        <li class="active">Laporan Penerimaan Retur</li>
      </ol>
    </section>
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <div class="col-xs-12">
                  <h4 style="text-align: center;"><strong>Laporan Penerimaan Retur Barang - PT. SPB</strong></h4>
                </div>
                <div class="col-xs-12">
                  <h4 style="text-align: center;">Periode Tanggal : <?php echo $tanggal ?></h4>
                </div>
                  <table id="tblLaporanReturMasukDetail" class="table table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                      <tr>
                        <th style="width: 10px; text-align: center;">No</th>
                        <th style="width: 20px; text-align: center;">Tanggal</th>
                        <th style="width: 20px; text-align: center;">ID</th>
                        <th style="width: 180px; text-align: center;">Retur dari</th>
                  ...
                  <div style="padding-top: 30px; padding-bottom: 10px;">
                    ...
                    <?php $link_print = site_url("laporan_retur_masuk/cetak_report_penerimaan_retur/".$tglAwal."/".$tglAkhir.""); ?>
                    <?php echo '<a class="btn btn-sm btn-success" href="'.$link_print.'" target="_blank" title="Print Laporan Penerimaan Retur" id="btn_print_laporan_retur_masuk"><i class="glyphicon glyphicon-print"></i> Cetak</a>';?>
                  </div>
              </div>  
            </div>
            <!-- /.box-body -->
