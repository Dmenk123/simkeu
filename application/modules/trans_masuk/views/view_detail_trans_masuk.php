          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="table-responsive">
                ...
                <div class="col-xs-12">
                  <h2 style="text-align: center;"><strong>Detail Penerimaan Barang - PT. SPB</strong></h2>
                </div>
                <div class="col-xs-4">
                  <h4 style="text-align: left;">Nama Petugas : <?php echo $val->nama_lengkap_user; ?></h4>
                </div>
                <div class="col-xs-4">
                  <h4 style="text-align: center;">Tanggal Penerimaan: <?php echo $val->tgl_trans_masuk; ?></h4>
                </div>
                <div class="col-xs-4">
                ...
                <?php endforeach ?>
                  ...
                  <div style="padding-top: 30px; padding-bottom: 10px;">
                    ...
                    <?php $link_print = site_url('trans_masuk/cetak_tanda_terima_barang/').$id; ?>
                    <?php echo '<a class="btn btn-sm btn-success" href="'.$link_print.'" title="Print Tanda Terima" id="btn_print_beli_detail" target="_blank"><i class="glyphicon glyphicon-print"></i> Cetak</a>';?>
                  </div>
              </div>  
            </div>
            <!-- /.box-body -->
